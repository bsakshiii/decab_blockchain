...
import { Card_dip } from "components/Card_dip";
// core components
...
function getSteps() {
  if (localStorage.getItem('type') !== null && localStorage.getItem('type') === "0") {
    return [ 'Choose source & destination',  'Select Driver', 'Ride Confirmed', 'Picked up','Destination Reached' ];
  } else {
    return [ 'Ride Confirmation', 'Picked Up', 'Dropped off' ];
  }
}
 function RideShareSteps(props) {
  ...
  const handleButtonClick = () => {
    // Navigate to a different page using window.location
    ...
    if (localStorage.getItem('type') !== null && localStorage.getItem('type') === "0") {
      switch (step) {
                  ...
                  </Typography>
                    {
                      ...
                      :
                        ...
                        <Typography variant="body2" color="textSecondary" component="p">
                          ...
                          {/* //Price: {localStorage.getItem('price')} ethers */}
                        </Typography>
                    }
        ...
        case 1:
          ...
          case 3:
          return !confirmed ? <div style={{marginTop: '15px', marginBottom: '15px'}}>
          Ready to begin your Ride-Share journey for eco-friendly rides at pocket - friendly rates
          </div> : 
          <div style={{marginTop: '15px', marginBottom: '15px'}}>
          Ready to begin your Ride-Share journey for eco-friendly rides at pocket - friendly rates
          </div>
  ...
  const handleNext = async (e) => {
    ...
    if (localStorage.getItem('type') !== null && localStorage.getItem('type') === "0") {
      ...
      // } 
        ...
        // })
        setActiveStep((prevActiveStep) => prevActiveStep + 1);
        //props.notifyNotificationListener("Driver Seletec")
                      ...
                      <div className={classes.actionsContainer}>
                        <div>
                          ...
                          <Button
                            ...
                            className={classes.button}
                          >
                            {activeStep === steps.length - 1 ? <Button onClick={handleButtonClick} variant="danger"> Pay Now</Button> : 'Next'}
                          </Button>
                        </div>
                      </div>
                    </StepContent>
