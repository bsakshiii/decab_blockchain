    ...
    componentWillMount() {
      ...
      this.setState({
        ...
        onSourcePlacesChanged: () => {
          ...
          //getting soruce address
          console.log(places);
          const src_address = places[0].formatted_address;
          console.log(src_address);
          localStorage.setItem('src_add', src_address);
        ...
        onDestinationPlacesChanged: () => {
          ...
          console.log(places);
          const dst_address = places[0].formatted_address;
          console.log(dst_address);
          localStorage.setItem('dst_add', dst_address);
          const bounds = new google.maps.LatLngBounds();
